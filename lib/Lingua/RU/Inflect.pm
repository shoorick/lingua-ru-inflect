...
sub _inflect_given_name {
    ...
    # Lastnames
    {
        ...
        last
            if $lastname =~ /[иы]х$/i
            && $lastname !~ /^(Аргер|Дитр|Либ|Мин|Ульр|Фрейн?дл|Эрл)их$/;
...
sub _MASCULINE_NAMES () {
    return qw(
        ...
        Арчи Аса
        Байгужа Боря Вафа Вано Ваня Вася Витя Вова Володя
        Габдулла Габидулла Гаврила Гаврило Гадельша Гайнулла Гайса Гайфулла
        Галимша Галиулла Гарри Гата Гдалья Гийора Гиля Гога Гоша Гошеа
        Данила Данило Данко Дарко Джанни Джеффри Джонни Джошуа Джиханша Дима
        ...
        Нэхэмья Овадья Петя Птахья Рахматулла Риза Рома Савва Садко Сафа Серёга
        Серёжа Сила Симха Сэадья Тао Тео Тоби Товия Толя Томми
